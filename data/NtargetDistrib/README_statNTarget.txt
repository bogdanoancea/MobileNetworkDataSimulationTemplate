...
2. <specs_time type=...> 
It describes the time variable and its parent is <statNTarget>.
...
4. <specs_mean>
It specifies the column with the mean value; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
5. <specs_mode>
It specifies the column with the mode value; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
6. <specs_median>
It specifies the column with the median value; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
7. <specs_min>
It specifies the column with the min value; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
8. <specs_max>
It specifies the column with the max value; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
9. <specs_Q1>
It specifies the column with the first quartile; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
10. <specs_Q3>
It specifies the column with the third quartile; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
11. <specs_IQR>
It specifies the column with the inter quartile range; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
12. <specs_sd>
It specifies the column with the standard deviation; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
13. <specs_cv>
It specifies the column with the coefficient of variation; its parent is <statNTarget>.
It contains 2 mandatory child elements and one optional element:
...
13. <specs_CI>
It specifies the columns with the lower and upper value of the CI; its parent is <statNTarget>.
...
14. <specs_distr type = ...>
It gives the name of the distribution used to generate the random values; its parent is <statNTarget>.
